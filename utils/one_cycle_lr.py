# Copied from https://github.com/pytorch/pytorch/blob/v1.3.0/torch/optim/lr_scheduler.py
# Our code is tested under pytorch 1.1.0, but OneCycleLR is implemented in 1.3.0. We cannot upgrade pytorch because the higher version does not work with CUDA 9.0, which is required for the correlation_cuda package.
