...
def get_edge_weights(flo, image, sem, edge, alpha):
    if edge == 'image':
...
def smooth_grad_1st(flo, image, sem, edge, alpha):
    weights_x, weights_y = get_edge_weights(flo, image, sem, edge, alpha)
...
def smooth_grad_2nd(flo, image, sem, edge, alpha):
    weights_x, weights_y = get_edge_weights(flo, image, sem, edge, alpha)
